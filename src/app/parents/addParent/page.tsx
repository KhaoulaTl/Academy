...
useEffect(() => {
  ...
  const handleAddParent = async (data: AddParentFormData) => {
    ...
    dispatch(createParentThunk(parentData)).then(async (res) => {
      if (res.meta.requestStatus === "fulfilled") {
        fetchParents();
        setAlertMessage("Un nouveau parent a été créé avec succès.");
      ...
      router.push(setting.routes.Parents);
        ...
        setAlertMessage("Échec de la création de parent.");
...
<div className="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
      ...
      <div className="mb-5 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="p-7">
              <form onSubmit={handleSubmitParent(handleAddParent)}>
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Chargement..." : "Ajouter Parent"}
                </button>
                <button
